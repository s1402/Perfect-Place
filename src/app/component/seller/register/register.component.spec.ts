...
describe('RegisterSellerComponent', () => {
  ...
  it('should navigate to verify email on successful register', () => {
    ...
    component.form.setValue(seller);
    component.register();
    ...
    expect(sharedServiceSpy.setIsSeller).toHaveBeenCalledWith(true);
    expect(routerSpy.navigate).toHaveBeenCalledWith(['/verify-email'], {
      queryParams: { user: UserTypes.SELLER },
    });
  });
